...
read -p "Go to https://safenodes.org/generate-wallet and generate your SafeNode Paper Wallet. Press enter to continue: "
...
echo
echo "SafeNode has been configured."
echo "Next steps:"
echo "- Restart the container (not needed if you are using boostra-host.sh)."
echo "- Fund the collateral address of you SafeNode Paper Wallet."
echo "- Send 1 SAFE to your local wallet to enable the node."
echo "After that the SafeNode should be working fine. You can double-check at https://safenodes.org/"